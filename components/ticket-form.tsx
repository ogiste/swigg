  ...
  return formState === 'error' ? (
    ...
    <form
      ...
      onSubmit={e => {
        ...
        const windowTop = window.top ? (window.top.outerHeight / 2 + window.top.screenY - 700 / 2) : 0;
        const windowLeft = window.top ? (window.top.outerWidth / 2 + window.top.screenX - 600 / 2) : 0;
